...
public interface SessionRepository extends JpaRepository<Session, String> {
    ...
    List<Session> findByGameIdAndUserId(String gameId, String userId);
    
    @Query("SELECT COUNT(DISTINCT s.userId) FROM Session s WHERE s.gameId = :gameId")
    long countDistinctUsersByGameId(@Param("gameId") String gameId);
}
