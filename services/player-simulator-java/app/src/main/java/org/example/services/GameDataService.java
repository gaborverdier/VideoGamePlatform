...
public class GameDataService {
    ...
    private void loadMockGames() {
        Game eldenRing = new Game("Elden Ring", 59.99, "RPG",
            ...
            4.8, 80, EnumSet.of(Platform.PC, Platform.PS5, Platform.XBOX));
        ...
        Game minecraft = new Game("Minecraft", 29.99, "Sandbox",
            ...
            4.5, 200, EnumSet.of(Platform.PC, Platform.PS5, Platform.XBOX, Platform.SWITCH));
        ...
        Game fifa = new Game("FIFA 24", 69.99, "Sport",
            ...
            4.0, 50, EnumSet.of(Platform.PC, Platform.PS5, Platform.XBOX));
        ...
        Game witcher = new Game("The Witcher 3", 39.99, "RPG",
            ...
            4.9, 120, EnumSet.of(Platform.PC, Platform.PS5, Platform.XBOX, Platform.SWITCH));
        ...
        Game gta = new Game("GTA V", 29.99, "Action",
            ...
            4.7, 100, EnumSet.of(Platform.PC, Platform.PS5, Platform.XBOX));
        ...
        Game cyberpunk = new Game("Cyberpunk 2077", 49.99, "RPG",
            ...
            4.2, 60, EnumSet.of(Platform.PC, Platform.PS5, Platform.XBOX));
        ...
        Game csgo = new Game("CS:GO", 0.00, "FPS",
            ...
            4.6, 300, EnumSet.of(Platform.PC));
        ...
        Game valorant = new Game("Valorant", 0.00, "FPS",
            ...
            4.4, 150, EnumSet.of(Platform.PC));
